...
set _OTMMARKUP_CFLAGS_NODEBUG=/nologo /c /W2 /MT /EHsc /TC /Zp1 /I%_OTMMARKUP_SRC%\common /DWIN32BIT /D_WINDOWS /D_WIN32_WINNT=0x0501 /D_OTM /wd4229
set _OTMMARKUP_CFLAGS_DEBUG=/nologo /c /W2 /MT /EHsc /TC /Zp1 /I%_OTMMARKUP_SRC%\common /DWIN32BIT /D_WINDOWS /D_WIN32_WINNT=0x0501 /Zi  /D_OTM /wd4229
set _OTMMARKUP_CUFLAGS_NODEBUG=/nologo /c /W2 /MT /EHsc /TC /Zp1 /I%_OTMMARKUP_SRC%\common /DWIN32BIT /D_WINDOWS /D_WIN32_WINNT=0x0501 /DUNICODE /D_UNICODE /D_OTM /wd4229
set _OTMMARKUP_CUFLAGS_DEBUG=/nologo /c /W2 /MT /EHsc /TC /Zp1 /I%_OTMMARKUP_SRC%\common /DWIN32BIT /D_WINDOWS /D_WIN32_WINNT=0x0501 /DUNICODE /D_UNICODE /Zi /D_OTM /wd4229
set _OTMMARKUP_CPPFLAGS_NODEBUG=/nologo /c /W2 /MT /EHsc /TP /Zp1 /I%_OTMMARKUP_SRC%\common /DWIN32BIT /D_WINDOWS /D_WIN32_WINNT=0x0501 /DUNICODE /D_UNICODE /D_OTM /wd4229
set _OTMMARKUP_CPPFLAGS_DEBUG=/nologo /c /W2 /MT /EHsc /TP /Zp1 /I%_OTMMARKUP_SRC%\common /DWIN32BIT /D_WINDOWS /D_WIN32_WINNT=0x0501 /DUNICODE /D_UNICODE /Zi /D_OTM /wd4229
